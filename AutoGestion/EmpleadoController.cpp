...
void EmpleadoController::crear() {
	...
	rlutil::locate(22, 10);
	//cin >> sueldo;
	sueldo = Funciones().inputDecimal(22,10,60);
	int opcion;
	do {
		rlutil::locate(12, 17);
		cout << "                                                                        ";
		...
		rlutil::locate(22, 16);
		//cin >> opcion;
		opcion = Funciones().inputNumero(22,16,40);
...
void EmpleadoController::editar()
{
	...
	cout << "INGRESE EL ID: ";
	//cin >> id
	id = Funciones().inputNumero(26,3,60);;
	...
	if (obj.getId() > 0)
	{
		...
		do
		{
			...
			cout << "NUEVO ESTADO: ";
			//cin >> nuevoEstado;
			nuevoEstado = Funciones().inputNumero(26,17,40);
...
void EmpleadoController::eliminar()
{
	...
	if (obj.getId() > 0 && !obj.getEliminado())
	{
		...
		do
		{
			...
			rlutil::locate(23, 21);
			//cin >> opcion;
			opcion = Funciones().inputNumero(23,21,40);
